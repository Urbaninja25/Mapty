...
class Running extends workout {
  ...
  calcPace() {
    //min/km ასე გამოიანგარიშება pace მატემატიკურად
...
class App {
  ...
  //---------------------------------create rendering methods (პირველი იისთვის რო მარკერი დასვას მეორე იმისთვის რო ფორმა გამიკეთოს)
